...
<head>
    ...
    <link rel="stylesheet" href="../css/reader-detailed-doc.css">
</head>
<body>
    <!-- Header -->
    <header class="header">
        <div class="header-container">
            ...
            <nav class="nav-menu">
                ...
                <a href="reader-search-doc.jsp" class="nav-link">Tìm Sách</a>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <nav class="breadcrumb">
                <a href="reader-home.jsp">Trang Chủ</a>
                <span class="separator">/</span>
                <a href="reader-search-doc.jsp">Tìm Kiếm</a>
                <span class="separator">/</span>
                <span class="current">Introduction to Algorithms</span>
            </nav>
            ...
            <div class="document-layout">
                ...
                <div class="document-content">
                    <h1 class="document-title">Introduction to Algorithms</h1>
                    ...
                    <section class="section">
                        <h2>Mô Tả</h2>
                        <p>
                            Một số sách về thuật toán rất nghiêm ngặt nhưng chưa đầy đủ; những cuốn khác bao quát nhiều tài liệu 
                            nhưng thiếu tính nghiêm ngặt. Introduction to Algorithms kết hợp độc đáo giữa tính nghiêm ngặt và 
                            tính toàn diện. Cuốn sách bao gồm nhiều thuật toán một cách sâu sắc, đồng thời làm cho việc thiết kế 
                            và phân tích chúng dễ tiếp cận với mọi cấp độ độc giả. Mỗi chương tương đối độc lập và có thể được 
                            sử dụng như một đơn vị học tập.
                        </p>
                        <p>
                            Các thuật toán được mô tả bằng tiếng Anh và bằng mã giả được thiết kế để dễ đọc đối với bất kỳ ai đã 
                            làm một chút lập trình. Các giải thích được giữ đơn giản mà không làm giảm độ sâu của phạm vi bao quát 
                            hoặc tính chặt chẽ toán học. Ấn bản thứ tư có các chương mới về cây van Emde Boas và thuật toán đa luồng, 
                            bổ sung đáng kể vào chương về đệ quy và phụ lục về ma trận.
                        </p>
                    </section>
                        ...
                        <table class="details-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Khoa Học Máy Tính, Thuật Toán</td>
                                </tr>
                            </tbody>
                        </table>
                    </section>
                    ...
                    <section class="section">
                        ...
                        <div class="topics-grid">
                            <span class="topic-tag">Cấu Trúc Dữ Liệu</span>
                            <span class="topic-tag">Thuật Toán Sắp Xếp</span>
                            <span class="topic-tag">Thuật Toán Đồ Thị</span>
                            <span class="topic-tag">Quy Hoạch Động</span>
                            <span class="topic-tag">Thuật Toán Tham Lam</span>
                            <span class="topic-tag">NP-Đầy Đủ</span>
                            <span class="topic-tag">Hình Học Tính Toán</span>
                            <span class="topic-tag">Khớp Chuỗi</span>
                        </div>
                    </section>
